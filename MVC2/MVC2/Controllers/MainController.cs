...
namespace MVC2.Controllers
{
        public class MainController : Controller
       {
            ...
            public ActionResult EmployeeResgistration() // employee registration form and the partial view of form is created 
            {
                try
                {
                    return View();
            ...
            public ActionResult Layout() // ques4) Explain Layout and how to set layout into view from Controller, View or globally
            {
                try
                {
                    ...
                    var MyLayout = View();
                    MyLayout.MasterName = "~/Views/Shared/_Layout.cshtml";
                    return MyLayout;
